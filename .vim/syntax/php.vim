...
" Repeat
syn keyword phpRepeat as do endfor endforeach endwhile for foreach while goto  contained
...
elseif exists("php_folding") && php_folding==2
  ...
  syn keyword phpDefine function  contained
  syn keyword phpStructure  abstract class interface namespace use  contained
  syn keyword phpException  catch throw try contained
  syn keyword phpStorageClass final global private protected public static  contained
endif
...
syntax keyword phpSpecialFunction containedin=ALLBUT,phpComment,phpStringDouble,phpStringSingle,phpIdentifier
  \ __construct __destruct __call __toString __sleep __wakeup __set __get __unset __isset __clone __set_state __callStatic __invoke
